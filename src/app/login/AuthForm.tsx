...
export function AuthForm({ error }: { error?: string }) {
    ...
    const copy = {
        ...
        signup: { title: "Sign Up", description: "Create your account to get started." },
    }
    ...
    return (
        ...
        <GoogleButton label={mode === "signup" ? "Sign up with Google" : "Sign in with Google"}/>
        <div className="my-4 text-center text-sm text-muted-foreground">or</div>
          <form className="space-y-3">
            ...
            <div className="flex flex-col items-center gap-4">
              <SubmitButton formAction={mode === 'signup' ? signUp : logIn} className="w-full">

        ...
        >
          <AnimatePresence mode="popLayout">
            {hoveredIndex === item.id && (
              ...
              >
                <div className="absolute inset-x-10 z-30 w-[20%] -bottom-px bg-linear-to-r from-transparent via-primary to-transparent h-px" />
          ...
          <Image
            ...
            src={item.image}
            alt={item.name}
            className="object-cover m-0! p-0! object-center rounded-full h-14 w-14 border-2 group-hover:scale-105 group-hover:z-30 border-background relative transition duration-500 cursor-pointer"
